...
describe("procrastination / perfectionism / gratitude", () => {
  ...
  it("are fully localized into es/fr (taglines, scales, and items)", () => {
    for (const id of ["procrastination-pps", "perfectionism-2f", "gratitude-gq6", "self-efficacy-gse", "emotion-regulation-erq", "self-control-bscs", "eysenck-pen", "perceived-stress", "worry-checkin", "zkpq-alt5", "tci-cloninger", "sensation-seeking", "panas-affect", "ryff-wellbeing", "burnout-mbi"]) {
      const inst = get(id);
