...
const GOAL_MAP: Record<GoalKey, string[]> = {
  ...
  wellbeing: ["emotional-intelligence", "self-compassion-scs", "mindfulness-ffmq", "emotion-regulation-erq", "gratitude-gq6", "perma-flourishing", "meaning-mlq", "brief-resilience", "money-scripts"],
