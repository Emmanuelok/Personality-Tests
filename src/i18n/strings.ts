...
const en: Dict = {
  ...
  "iep.comm": "Your communication portrait", "iep.commSub": "One picture woven from your communication & conflict tests — the skills that travel across every relationship, with partners, teammates, and everyone.",
  "iep.well": "Your wellbeing portrait", "iep.wellSub": "One picture woven from your wellbeing tests — five dimensions of flourishing, from self-kindness to meaning, cross-checked across everything you've taken.",
  "iep.coach": "Your wellbeing coach", "iep.coachSub": "An auto-built plan focused on your growth edge — from diagnosis to daily practice.", "iep.coachEdge": "Growth edge", "iep.coachSchedule": "📅 Schedule these practices",
...
const es: Dict = {
  ...
  "iep.comm": "Tu retrato de comunicación", "iep.commSub": "Una imagen entretejida a partir de tus pruebas de comunicación y conflicto: las habilidades que viajan por cada relación, con parejas, compañeros y todo el mundo.",
  "iep.well": "Tu retrato de bienestar", "iep.wellSub": "Una imagen entretejida a partir de tus pruebas de bienestar: cinco dimensiones del florecimiento, de la autobondad al sentido, contrastadas en todo lo que has hecho.",
  "iep.coach": "Tu coach de bienestar", "iep.coachSub": "Un plan creado automáticamente y centrado en tu punto de crecimiento: del diagnóstico a la práctica diaria.", "iep.coachEdge": "Punto de crecimiento", "iep.coachSchedule": "📅 Programar estas prácticas",
...
const fr: Dict = {
  ...
  "iep.comm": "Votre portrait de communication", "iep.commSub": "Une image tissée à partir de vos tests de communication et de conflit : les compétences qui traversent chaque relation, avec partenaires, coéquipiers et tout le monde.",
  "iep.well": "Votre portrait de bien-être", "iep.wellSub": "Une image tissée à partir de vos tests de bien-être : cinq dimensions de l'épanouissement, de la bienveillance envers soi au sens, recoupées sur tout ce que vous avez fait.",
  "iep.coach": "Votre coach de bien-être", "iep.coachSub": "Un plan construit automatiquement, centré sur votre axe de progrès — du diagnostic à la pratique quotidienne.", "iep.coachEdge": "Axe de progrès", "iep.coachSchedule": "📅 Planifier ces pratiques",
